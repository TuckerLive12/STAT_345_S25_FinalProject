...
#Adds all the csv file names into an array to make scraping easier
...
FileLocation <- rep("Placeholder", length(states))

for (i in 1:length(states)) {
  FileLocation[i] <- str_replace(file_location, "TOREPLACE", states[i])
}
