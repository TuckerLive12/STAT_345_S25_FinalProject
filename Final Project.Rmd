...
dat2 = left_join(counties, dat1, by = "COUNTYFP")
...
c = ggplot(data = map_data) +
  geom_sf(aes(fill = MOSTFREQUENT), color = "white", size = 0.1) +
>>>>>>> 5304d0ca0e1f444338b7dc96c0f84957c4b9e6e5
  theme_minimal() +
  labs(
...
Compilation |>
  slice_max(N, n = 1, with_ties = FALSE) |>
  filter(MOSTFREQUENT %in% c("Ar", "Cir", "Cr", "Fs", "Gove", "Hwy", "K", "Lake", "Liv", "Lr", "P", "Pl", "Pvt", "R", "Road", "Rte", "S", "Sfc", "T", "Trl", "Way")) |>
  arrange(MOSTFREQUENT)

Compilation |>
  filter(MOSTFREQUENT %in% c("Aa", "Alt", "Aly", "Area", "Ash", "Base", "Bcr", "Blm", "Cs", "D", "Dd", "Dove", "Drum", "Ee", "Ew", "Expy", "Eye", "F", "Farm", "Fork", "G", "Gate", "H", "Hcr", "Hh", "Hts", "Hu", "I", "J", "L", "La", "Lane", "Lobo", "No", "Ns", "Null", "P", "Park", "Path", "Pfrd", "Pp", "Pr", "Pvt", "R", "Rdg", "Road", "Row", "Run", "Scr", "Sd", "Spur", "Sq", "Ter", "Tpke", "U", "V", "Xing", "Y")) |>
  count(MOSTFREQUENT) |>
  arrange(n)
...
dat <- read_csv("Data_Scraping_and_Database/Oregon_Roads_2023.csv", col_types = cols(LINEARID = "c") )
