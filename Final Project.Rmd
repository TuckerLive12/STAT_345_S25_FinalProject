...
Compilation |>
  filter(SUFFIX %in% c("Aa", "Alt", "Aly", "Area", "Ash", "Base", "Bcr", "Blm", "Cs", "D", "Dd", "Dove", "Drum", "Ee", "Ew", "Expy", "Eye", "F", "Farm", "Fork", "G", "Gate", "H", "Hcr", "Hh", "Hts", "Hu", "I", "J", "L", "La", "Lane", "Lobo", "No", "Ns", "Null", "P", "Park", "Path", "Pfrd", "Pp", "Pr", "Pvt", "R", "Rdg", "Road", "Row", "Run", "Scr", "Sd", "Spur", "Sq", "Ter", "Tpke", "U", "V", "Xing", "Y")) |>
  count(SUFFIX) |>
  arrange(n)
